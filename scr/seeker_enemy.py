...
class Seeker(Tank):
    def __init__(self, x, y, combat_x, combat_y) -> None:
        ...
        self.source_img = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("assets/Green_Tank_Sprite.png").convert_alpha(), (40, 70)),180)
        self.image = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("assets/Green_Tank_Sprite.png").convert_alpha(), (40, 70)),180)
